...
PATH_PRED = 'try_10/pred_10.csv'
PATH_REZ = 'try_10/rez.csv'
...
for key in word_stat_dict:
    ...
    most_freq_dict[key] = list(word_stat_dict[key].keys())[0]

most_freq_dict_all = {}
for key in all_words_stat_dict:
    most_freq_dict_all[key] = list(all_words_stat_dict[key].keys())[0]
